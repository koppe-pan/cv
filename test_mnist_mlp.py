...
def main():
    ...
    parser.add_argument('--model', '-m', default='result/model_final', help='Path to the model for test')
    parser.add_argument('--image', '-i', default='image.png', help='Path to the model for test')
...
# Print the result
        for item in torch.squeeze(predicted):
            print('Predicted label : {}'.format(item.item()))
